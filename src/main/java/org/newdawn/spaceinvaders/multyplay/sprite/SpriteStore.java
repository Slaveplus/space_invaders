...
/**
 * 게임의 스프라이트를 위한 리소스 관리자입니다. 게임 리소스를 어디서 어떻게 가져오는지가
 * 종종 매우 중요합니다. 대부분의 경우 리소스를 가져와서 향후 사용을 위해
 * 캠싱하는 중앙 리소스 로더를 가지는 것이 합리적입니다.
 * <p>
 * [singleton]
 * <p>
 * @author Kevin Glass
...
public class SpriteStore {
	...
	/** 캠시된 스프라이트 맵, 참조에서 스프라이트 인스턴스로 */
	private HashMap<String, Sprite> sprites = new HashMap<>();
	
	/**
	 * 스토어에서 스프라이트를 검색합니다
	 * 
	 * @param ref 스프라이트에 사용할 이미지에 대한 참조
	 * @return 요청된 참조의 가속 이미지를 포함하는 스프라이트 인스턴스
	 */
