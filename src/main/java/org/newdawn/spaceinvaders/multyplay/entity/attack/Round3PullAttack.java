...
public class Round3PullAttack extends Entity {
    ...
    public Round3PullAttack(MultiplayerGameContext game, int x, int y) {
    ...
    private void launchBlackHoleAttack() {
        Round3BlackHoleAttack center = new Round3BlackHoleAttack(game, (int) this.x, (int) this.y);
        game.addEntity(center);
        Round3BlackHoleAttack left = new Round3BlackHoleAttack(game, (int) this.x - 100, (int) this.y);
        game.addEntity(left);
        Round3BlackHoleAttack right = new Round3BlackHoleAttack(game, (int) this.x + 100, (int) this.y);
