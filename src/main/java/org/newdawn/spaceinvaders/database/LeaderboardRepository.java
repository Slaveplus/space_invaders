...
public final class LeaderboardRepository {
    ...
    public static List<LeaderboardRecord> loadRecords(FirebaseDatabaseClient db,
        ...
        for (Object value : raw.values()) {
            ...
            Object namesObj = entry.get("playerNames");
            List<String> names;
            if (namesObj instanceof List) {
                ...
                names = new ArrayList<>();
                String[] parts = ((String) namesObj).split(",");
            ...
            LeaderboardRecord.Mode resolvedMode = mode;
            Object modeValue = entry.get("mode");
            if (modeValue instanceof String) {
                resolvedMode = LeaderboardRecord.Mode.fromString((String) modeValue);
            }
